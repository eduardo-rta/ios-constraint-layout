...
public extension ConstraintLayout {
    ...
    func widthEqualsTo(_ view: UIView, multiplier: CGFloat = 1, constant: CGFloat = 0, withPriority priority: Float? = nil) -> ConstraintLayout {
        return self.widthEqualsTo(view.widthAnchor, multiplier: multiplier, constant: constant, withPriority: priority)
    }
    ...
    func widthEqualsTo(_ layoutGuide: UILayoutGuide, multiplier: CGFloat = 1, constant: CGFloat = 0, withPriority priority: Float? = nil) -> ConstraintLayout {
        return self.widthEqualsTo(layoutGuide.widthAnchor, multiplier: multiplier, constant: constant, withPriority: priority)
    }
    ...
    func widthEqualsToSafeArea(_ view: UIView, multiplier: CGFloat = 1, constant: CGFloat = 0, withPriority priority: Float? = nil) -> ConstraintLayout {
        return self.widthEqualsTo(view.safeAreaLayoutGuide, multiplier: multiplier, constant: constant, withPriority: priority)
    }
    ...
    func widthEqualsHeight(_ view: UIView, multiplier: CGFloat = 1, constant: CGFloat = 0, withPriority priority: Float? = nil) -> ConstraintLayout {
        return self.widthEqualsTo(view.heightAnchor, multiplier: multiplier, constant: constant, withPriority: priority)
    }
    ...
    @discardableResult
    func widthLessThanOrEqualTo(_ height: CGFloat, withPriority priority: Float? = nil) -> ConstraintLayout {
        return self.configureConstraint(
                key: .widthLessThanOrEqualToConstant,
                buildConstraint: {
                    self.owner.widthAnchor.constraint(lessThanOrEqualToConstant: height)
                },
                priority: priority
        )
    }
